...
public class Sciencefagment extends Fragment {
   ...
   private String category = "science";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_sciencefagment, container, false);

        recyclerViewScince =v.findViewById(R.id.recyclerviewodscience);
        modelClassArrayList =new ArrayList<>();
        recyclerViewScince.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter =new Adapter(getContext(),modelClassArrayList);
        recyclerViewScince.setAdapter(adapter);
