...
public class Entertainmentfragment extends Fragment {
    ...
    private RecyclerView recyclerViewEnterTanment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_entertainmentfragment, container, false);

        recyclerViewEnterTanment =v.findViewById(R.id.recyclerviewodentertainment);
        modelClassArrayList =new ArrayList<>();
        recyclerViewEnterTanment.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter =new Adapter(getContext(),modelClassArrayList);
        recyclerViewEnterTanment.setAdapter(adapter);
